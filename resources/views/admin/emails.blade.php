            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr style="background: #0000ff; ">
                  <td style="color:white">{{$pedido->nomedoprojecto}}</td>
                  <td style="color:white">{{$pedido->email}}
                  </td>
                  <td style="color:white">{{$pedido->descricao}}</td>
                    <td><a target="_blank" href="{{asset('files/'.$pedido->cv)}}">CV</a> </td>
                    <td>{{$pedido->created_at}}</td>
                    <td><button class="btn btn-primary" id="" style="background-color: #00a65a"  onclick="reademail({{$pedido->id}})" >Ler</button></td>
                    <td><button class="buscarParaRemover btn " style="background-color: #FF5733" id="{{$pedido->id}}" data-toggle="modal" data-target="#modelpararemover"data-id="{{$pedido}}" data-target="exampleModalCenter">Remover</button></td>
                </tr>
                @else
                        <tr>
                            <td>{{$pedido->nomedoprojecto}}</td>
                            <td>{{$pedido->email}}
                            </td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Remover Email</h5>
            ...
            <form>
                <div class="modal-body">
                    <h4> Desejas realmente remover  email de </h4>
                    <h3 id="nomedelete"></h3>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" onclick="emailremove()">Sim</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    $('.buscarParaRemover').on('click',function(){
        ...
        document.getElementById("nomedelete").innerHTML=objJson.email+"?";
